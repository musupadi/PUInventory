...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="<?php echo base_url("Home/Location")?>"><i class="fa fa-map"></i> <span>Location</span></a></li>
        <li><a href="<?php echo base_url("Transaction/Asset")?>"><i class="fa fa-history"></i> <span>History Transaction</span></a></li>
